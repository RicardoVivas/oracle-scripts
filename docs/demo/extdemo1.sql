rem
rem $Header: rdbms/demo/extdemo1.sql /st_rdbms_11.2.0/1 2010/07/21 11:35:42 schakrab Exp $
rem
rem extdemo1.sql
rem
...
is
  ...
  BEGIN
   ...
   stmt1 := 'CREATE TABLE ' ||
            ...
            Dbms_Assert.Enquote_Name(ia.IndexName || '_pidx', FALSE) ||
   ...
   stmt2 := ' INSERT INTO '||
            ...
            Dbms_Assert.Enquote_Name(ia.IndexCols(1).TableName, FALSE) || ' P' ||
            ' WHERE P.ROWID = :rr)';
  ...
  BEGIN
    ...
    dbms_sql.bind_variable(cnum, ':cpos', cmppos);
    dbms_sql.bind_variable(cnum, ':cval', cmpval);
