/
/ $Header: rdbms/demo/aqxmlREADME.txt /unix/9 2010/02/26 16:53:35 rbhyrava Exp $
/
/ aqxmlREADME.txt
/
...
(6) Verify the setup:
    ...
    Please refer to OC4J SSL configuration section that is specific to oc4j
...
used. 
   ...
   (b) The following tags in
    ...
    If you are using OC4J 10g version, sample entry for aqdemo web-app:

<web-site xmlns:xsi=..  port="..." secure="true" display-name="OC4J 10g (10.1.3) Default Web Site"
schema-major-version="10" schema-minor-version="0" >
        ....
        <web-app application="system" name="dms" root="/dmsoc4j" />
        <web-app application="javasso" name="javasso-web" root="/jsso" />
        <web-app application="aqxmldemo" name="aqxmldemo_web"
max-inactivity-time="200" shared="true" load-on-startup="true"
root="/aqserv/servlet" />
        <access-log path="../log/http-web-access.log" split="day" />
<ssl-config keystore="....j2ee/home/keystore"
keystore-password="...." />
</web-site>
