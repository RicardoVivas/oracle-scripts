...
/
show errors;
grant execute on waitfor_sql to public;
...
begin
  ...
  WAITFOR_SQL(
    SQL_STMT_IN => 
         'select 1 from gv$streams_capture where ' ||
...
-------------------------------------------------------
connect stradm/stradm@inst1
insert into scott.emp (empno, ename) values (1, 'scott');
insert into scott.emp (empno, ename) values (2, 'tiger');
commit;
