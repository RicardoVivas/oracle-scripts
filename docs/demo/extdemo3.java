/* $Header: rdbms/demo/extdemo3.java /st_rdbms_11.2.0/1 2010/07/21 11:35:42 schakrab Exp $ */
...
/*
   ...
   MODIFIED    (MM/DD/YY)
    schakrab    07/19/10 - Backport schakrab_bug-9591432 from main
...
/**
 *  @version $Header: rdbms/demo/extdemo3.java /st_rdbms_11.2.0/1 2010/07/21 11:35:42 schakrab Exp $
 *  @author  rshaikh 
...
public class extdemo3 implements ORAData, ORADataFactory
{
    ...
    throws java.sql.SQLException
  {
     ...
     ******************************/
    cstmt = conn.prepareCall("DELETE from "
           + "\"" + ia.getIndexSchema() + "\""  + "." + "\"" + ia.getIndexName() 
	   +"_sbtree\" where f1= ?" );

    cstmt.setString(1, oldval);
    cstmt.executeUpdate();
    ...
    throws java.sql.SQLException
  {
     ...
     ******************************/
    cstmt = conn.prepareCall("UPDATE "
            + "\"" + ia.getIndexSchema() + "\""  + "." + "\"" + ia.getIndexName() 
	    +"_sbtree\" SET f1 = ? WHERE f1 = ?");
    
    cstmt.setString(1, newval);
    cstmt.setString(2, oldval);
    cstmt.executeUpdate();
