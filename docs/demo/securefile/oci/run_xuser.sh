...
# NEW SPACE TEST
      ...
      do
        ...
        LocatorAPI_Insert lob_demo lob_demo $lobsize $commitsize $iter $UserCount >>${lobtype}_${lobsize}_${UserCount}.log &
...
# READ TEST 
      ...
      do
        ...
        LocatorAPI_Select lob_demo lob_demo $lobsize $commitsize $iter $UserCount >>${lobtype}_${lobsize}_${UserCount}.log &
        let UserCount=UserCount+1;
      done
